		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("consul_acl_token.test", "templated_policies.#", "1"),
					...
					resource.TestCheckResourceAttr("consul_acl_token.test", "service_identities.0.template_name", "builtin/service"),
				),
			},
			{
				Config: testResourceACLTokenConfigUpdate,
